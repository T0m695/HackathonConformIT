...
def transcribe_and_get_output():
    """Envoie l'audio à Transcribe, attend, et retourne le résultat."""
...
if __name__ == "__main__":
    ...
    record_audio()
    transcript = transcribe_and_get_output()
    
    if transcript:
        print(f"\n✅ Transcription finale : {transcript}")
    else:
        print("\n❌ Aucune transcription obtenue")